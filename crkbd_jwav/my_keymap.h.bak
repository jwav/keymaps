...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(KC_LCTL, KC_A, KC_Z, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_RCTL, KC_LALT, HOME_A, HOME_S, HOME_D, HOME_F, KC_G, KC_H, HOME_J, HOME_K, HOME_L, HOME_M, KC_LALT, KC_LGUI, HOME_Z, HOME_X, KC_C, KC_V, KC_B, KC_N, fCOMM, fDOT, HOME_SLSH, HOME_QUOT, KC_RGUI, LCTL_T(KC_SPC), LT(2,KC_ENT), LSFT_T(KC_TAB), RSFT_T(KC_BSPC), LT(1,KC_SPC), LALT_T(KC_ENT)),
	...
	[2] = LAYOUT_split_3x6_3(KC_TRNS, KC_PAST, KC_P1, KC_P2, KC_P3, KC_PPLS, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_PSCR, KC_TRNS, KC_TRNS, HOME_NUM_0, HOME_NUM_4, HOME_NUM_5, HOME_NUM_6, KC_PDOT, KC_VOLD, KC_LEFT, KC_DOWN, KC_RGHT, KC_VOLU, KC_TRNS, KC_TRNS, KC_PSLS, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_PGDN, KC_BSPC, KC_CAPS, KC_DEL, KC_NUM, KC_TRNS, LCTL_T(KC_ENT), DF(0), DF(2), KC_TRNS, LT(3,KC_ENT), LALT_T(KC_SPC)),
