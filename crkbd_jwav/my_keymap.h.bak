...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x6_3(KC_TRNS, HOME_NUM_MULT, HOME_NUM_1, HOME_NUM_2, HOME_NUM_3, HOME_NUM_PLUS, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_PSCR, KC_TRNS, KC_TRNS, HOME_NUM_0, HOME_NUM_4, HOME_NUM_5, HOME_NUM_6, HOME_NUM_DOT, LCTL(KC_LEFT), KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_RGHT), KC_TRNS, KC_TRNS, HOME_NUM_DIV, HOME_NUM_7, HOME_NUM_8, HOME_NUM_9, HOME_NUM_MINUS, KC_PGDN, KC_BSPC, KC_CAPS, KC_DEL, KC_NUM, KC_TRNS, LCTL_T(KC_ENT), DF(0), DF(2), KC_TRNS, LT(3,KC_ENT), LALT_T(KC_SPC)),
