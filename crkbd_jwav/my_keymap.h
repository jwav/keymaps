...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(KC_LCTL, KC_A, KC_Z, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_RCTL, KC_LALT, HOME_A, HOME_S, HOME_D, HOME_F, KC_G, KC_H, HOME_J, HOME_K, HOME_L, HOME_M, KC_LALT, KC_LGUI, KC_W, KC_X, KC_C, KC_V, KC_B, KC_N, fCOMM, fDOT, fSLSH, fQUOT, KC_RGUI, LCTL_T(KC_SPC), LT(2,KC_ENT), LSFT_T(KC_TAB), RSFT_T(KC_BSPC), LT(1,KC_SPC), LALT_T(KC_ENT)),
	[1] = LAYOUT_split_3x6_3(KC_TRNS, fAMP, fLCBR, fLBRC, fLABK, fTILD, fDEG, fRABK, fRBRC, fRCBR, fGRV, KC_TRNS, KC_TRNS, fHASH, fDQUO, fUNDS, fLPRN, fDLR, fCIRC, fRPRN, fMINS, fCOLN, fASTR, KC_TRNS, KC_TRNS, fEXLM, fEQL, fSCLN, fPLUS, fPERC, fMICR, fPIPE, FR_AT, fBSLS, fQUES, KC_TRNS, LCTL_T(KC_ENT), LT(3,KC_SPC), KC_TRNS, DF(2), DF(0), KC_RALT),
